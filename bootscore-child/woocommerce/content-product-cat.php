...
?>
<div <?php wc_product_cat_class(apply_filters('bootscore/class/woocommerce/col', 'col-6 col-md-6 col-lg-4 col-xxl-3'), $category); ?>>
  <div class="<?= apply_filters('bootscore/class/woocommerce/product/card', 'card h-100'); ?>">
    <?php
    /**
