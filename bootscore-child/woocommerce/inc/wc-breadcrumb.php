...
if (!function_exists('bs_woocommerce_breadcrumbs')) :
  ...
  function bs_woocommerce_breadcrumbs() {
    return array(
      ...
      <li class='breadcrumb-item'><a class='" . apply_filters('bootscore/class/breadcrumb/item/link', '') . "' href='" . esc_url(home_url()) . "'>" . apply_filters('bootscore/icon/home', '<i class="bi bi-house-door-fill"></i>') . " <span class='visually-hidden'>" . __('Home', 'bootscore') . "</span></a></li>", // Use the filter for home icon - Bootstrap Icons
      'wrap_after'  => '</ol></nav>',
