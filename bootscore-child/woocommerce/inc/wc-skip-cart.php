...
function bootscore_widget_shopping_cart_proceed_to_checkout() {
  echo '<a href="' . esc_url( wc_get_cart_url() ) . '" class="btn btn-outline-secondary btn-lg">' . esc_html__('Cart', 'woocommerce') . '</a>';
  echo '<a href="' . esc_url( wc_get_checkout_url() ) . '" class="btn btn-primary btn-lg">' . esc_html__('Checkout', 'woocommerce') . '</a>';
}
